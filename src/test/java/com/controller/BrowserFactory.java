...
public class BrowserFactory {
    ...
    //Note, this method can be extended to all other browsers
        ...
        switch (browserName) {
            ...
            if(Runner.gridDockerExecution){
              ...
              DesiredCapabilities desiredCapabilities=  setZaleniumCaps(browserName);
                ...
                System.setProperty("webdriver.chrome.driver", Runner.RESOURCES_PATH+"//chromedriver.exe");
                String pathToChromeExe=Runner.RESOURCES_PATH+"//chromedriver.exe";


                ChromeDriverService service= new ChromeDriverService.Builder()
                                                    .usingDriverExecutable(new File(pathToChromeExe))
                                                    .usingAnyFreePort()
                                                    .build();
                ...
                webDriver.get().manage().timeouts().implicitlyWait(40, TimeUnit.SECONDS);
            }
